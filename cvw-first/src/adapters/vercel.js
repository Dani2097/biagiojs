/**
 * CVW-First — Adapter Vercel (SSR on-demand su serverless function).
 *
 ...
 *
 * 1. `api/ssr.js`:
 *      import { createHandler } from 'cvw-first/adapters/vercel';
 *      export default createHandler();          // projectDir = root del repo
 *
 * 2. `vercel.json`:
 *      {
 *        "buildCommand": "cvw build .",
 ...
 * .page.ts non sono supportate in runtime serverless: usa .page.js/.cvw
