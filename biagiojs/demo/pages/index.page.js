...
export default function ({ ExperimentEngine, userId }) {
  ...
  g.add(new PerfNode('hero', {
    ...
    render: () => `<footer><div class="logo">VELO<span>CE</span></div><small>Sito generato da biagiojs — rendering conversion-driven, idratazione adattiva, SEO automatica.</small></footer>`,
  }));
